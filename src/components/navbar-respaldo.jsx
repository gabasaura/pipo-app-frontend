                    ...
                    >
                        ...
                        <Offcanvas.Body>
                            <Nav className="flex m-auto">
                                ...
                                <Nav.Link as={Link} to="/faq" className={location.pathname === '/faq' ? 'active' : ''}>Faq <LiveHelpIcon/></Nav.Link>
                                <Nav.Link as={Link} to="/contact" className={location.pathname === '/contact' ? 'active' : ''}>Contact</Nav.Link>
                                {store.access_token ? (
                                    <>
                                        <Nav.Link as={Link} to="/userprofile" className={location.pathname === '/userprofile' ? 'active' : ''}>User Profile<PersonIcon /></Nav.Link>
                                        ...
                                        <Nav.Link as={Link} to="/" className={"nav-link " + (location.pathname === "/" ? "active" : "")} onClick={actions.logout}>Log Out<ExitToAppIcon/></Nav.Link>
                                    </>
                                ) : (
                                    <>
                                        <Nav.Link as={Link} to="/login" className={location.pathname === '/login' ? 'active' : ''}>Log In < LoginIcon/></Nav.Link>
